...
enum {
		EEMB_BIND_SUB_TP_UINT = 0,
		EEMB_BIND_SUB_TP_INT,
		EEMB_BIND_SUB_TP_FP,
		EEMB_BIND_SUB_TP_STRUCT,
		EEMB_BIND_SUB_TP_MB_L_C,
		EEMB_BIND_SUB_TP_MB_L_H,
		EEMB_BIND_SUB_TP_MB_L_I,
		EEMB_BIND_SUB_TP_MB_REMOTE,
		EEMB_BIND_SUB_TP_MB_C_REMOTE,
		EEMB_BIND_SUB_TP_MB_L_C_ITER,
		EEMB_BIND_SUB_TP_MB_L_H_ITER,
		EEMB_BIND_SUB_TP_MB_L_I_ITER,
		EEMB_BIND_SUB_TP_MB_L,
		EEMB_BIND_SUB_TP_MB_L2,
		EEMB_BIND_SUB_TP_CSTRING,
		EEMB_BIND_SUB_TP_STRING,
		EEMB_BIND_SUB_TP_COUNT
} 
